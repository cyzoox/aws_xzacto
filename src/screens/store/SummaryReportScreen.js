  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      const transactionItems =
        transactionsResult.data.listSaleTransactions.items;
        ...
        if (transaction.items && Array.isArray(transaction.items)) {
          ...
          transaction.items.forEach(item => {
            ...
            if (categorySales[defaultCategoryId]) {
              ...
              categorySales[defaultCategoryId].sales +=
                transaction.total / transaction.items.length; // Simple average
            }
          });
        }
        ...
        if (transaction.discount && transaction.discount > 0) {
          ...
          discountsList.push({
            name: transaction.notes?.includes('Discount applied:')
              ? transaction.notes.split('Discount applied:')[1]?.trim() ||
                'Regular Discount'
              : 'Regular Discount',
      ...
      <Modal
        ...
        <View style={styles.modalContent}>
          ...
          <TouchableOpacity
            style={[
              styles.dateRangeButton,
              dateRange === 'yesterday' && styles.activeDateRange,
            ]}
            onPress={() => {
            ...
            <Text
              style={[
                styles.dateRangeText,
                dateRange === 'yesterday' && styles.activeDateRangeText,
              ]}>
              Yesterday
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.dateRangeButton,
              dateRange === 'thisWeek' && styles.activeDateRange,
            ]}
            onPress={() => {
            ...
            <Text
              style={[
                styles.dateRangeText,
                dateRange === 'thisWeek' && styles.activeDateRangeText,
              ]}>
              This Week
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.dateRangeButton,
              dateRange === 'thisMonth' && styles.activeDateRange,
            ]}
            onPress={() => {
            ...
            <Text
              style={[
                styles.dateRangeText,
                dateRange === 'thisMonth' && styles.activeDateRangeText,
              ]}>
              This Month
            </Text>
          </TouchableOpacity>
  ...
  return (
    <Provider>
      <View style={styles.container}>
        <Appbar title="Summary Report" onBack={() => navigation.goBack()} />
        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.rowValue}>
                {formatMoney(summaryStats.totalExpenses, {
                  symbol: '₱',
                  precision: 2,
                })}
              </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.row, styles.totalRow]}>
              <Text style={styles.rowLabel}>Total Net Sales</Text>
              <Text style={styles.rowValue}>
                {formatMoney(summaryStats.totalNetSales, {
                  symbol: '₱',
                  precision: 2,
                })}
              </Text>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.row, styles.totalRow]}>
              ...
              <Text style={styles.rowValue}>
                {formatMoney(summaryStats.totalDiscounts, {
                  symbol: '₱',
                  precision: 2,
                })}
              </Text>
