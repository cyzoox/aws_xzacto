...
const StoreDashboard = ({navigation, route}) => {
  ...
  const generateCashierPerformanceData = (cashiers, transactions) => {
    ...
    const sorted = [...cashierPerformance].sort(
      ...
      <ScrollView>
        ...
        <View style={styles.periodSelector}>
          <TouchableOpacity
            style={[
              styles.periodButton,
              selectedPeriod === 'day' ? styles.activePeriod : null,
            ]}
            onPress={() => setSelectedPeriod('day')}>
            <Text
              style={[
                styles.periodText,
                selectedPeriod === 'day' ? styles.activePeriodText : null,
              ]}>
              Today
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.periodButton,
              selectedPeriod === 'week' ? styles.activePeriod : null,
            ]}
            onPress={() => setSelectedPeriod('week')}>
            <Text
              style={[
                styles.periodText,
                selectedPeriod === 'week' ? styles.activePeriodText : null,
              ]}>
              Week
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.periodButton,
              selectedPeriod === 'month' ? styles.activePeriod : null,
            ]}
            onPress={() => setSelectedPeriod('month')}>
            <Text
              style={[
                styles.periodText,
                selectedPeriod === 'month' ? styles.activePeriodText : null,
              ]}>
              Month
            </Text>
          </TouchableOpacity>
        ...
        <View style={styles.summaryContainer}>
          ...
          <View style={styles.summaryCard}>
            <Text style={styles.summaryValue}>
              ₱{salesStats.averageOrder.toFixed(2)}
            </Text>
            ...
            <View>
              {topCashiers.map((cashier, index) => (
                <View key={cashier.id} style={styles.cashierRow}>
                  ...
                  <Text style={styles.cashierSales}>
